 ...
 * href="http://tpop.awl.com/">Addison-Wesley</a> web site, which says: <cite>"You may use this code for any purpose, as long as you leave the copyright notice and book citation attached"
 * </cite>.
 * 
...
public class CSVFileReader extends CSVFile {
	 ...
	 */
	public CSVFileReader(BufferedReader in) throws FileNotFoundException {
		super();
		this.in = in;
	}
	 ...
	 *             If the file to be read does not exist
	 */
	public CSVFileReader(BufferedReader in, char sep)
			throws FileNotFoundException {
		super(sep);
		this.in = in;
	}
	 ...
	 *             If the file to be read does not exist
	 */
	public CSVFileReader(BufferedReader in, char sep, char qual)
			throws FileNotFoundException {
		super(sep, qual);
		this.in = in;
	}
